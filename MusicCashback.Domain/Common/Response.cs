...
namespace MusicCashback.Domain.Common
{
    public class Response
    {
        ...
        public static Response BuildInternalServerError(string msg = "")
        {
            msg = !string.IsNullOrEmpty(msg) ? " Erro: " + msg : "";

            return new Response()
            {
                Success = false,
                Errors = AddError("Não foi possível processar sua solicitação. Tente novamente mais tarde." + msg),
                StatusCode = 500
            };
        }
